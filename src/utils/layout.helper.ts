...
export const AboutLayout = {
    lg: [
      ...
      { i: "e", x: 0, y: 3, w: 1, h: 1, isResizable: false },
      { i: "f", x: 0, y: 4, w: 1, h: 1, isResizable: false },
      { i: "g", x: 1, y: 2, w: 2, h: 2, isResizable: false },
      { i: "h", x: 1, y: 4, w: 2, h: 1, isResizable: false },
      { i: "i", x: 3, y: 2, w: 3, h: 3, isResizable: false },
      { i: "j", x: 0, y: 5, w: 2, h: 2, isResizable: false },
      { i: "k", x: 2, y: 5, w: 2, h: 2, isResizable: false },
      { i: "l", x: 4, y: 5, w: 2, h: 2, isResizable: false },
