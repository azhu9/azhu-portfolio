...
export const AboutLayout = {
    lg: [
      ...
      { i: "c", x: 4, y: 1, w: 2, h: 1, isResizable: false },
      { i: "d", x: 0, y: 3, w: 1, h: 1, isResizable: false },
      { i: "e", x: 0, y: 4, w: 1, h: 1, isResizable: false },
      { i: "f", x: 0, y: 5, w: 1, h: 1, isResizable: false },
      { i: "g", x: 1, y: 3, w: 2, h: 2, isResizable: false },
      { i: "h", x: 3, y: 2, w: 3, h: 3, isResizable: false },
      { i: "i", x: 0, y: 6, w: 2, h: 2, isResizable: false },
      { i: "j", x: 2, y: 6, w: 2, h: 2, isResizable: false },
      { i: "k", x: 4, y: 7, w: 2, h: 2, isResizable: false },
      // { i: "l", x: 0, y: 3, w: 1, h: 1, isResizable: false },
      // { i: "m", x: 1, y: 2, w: 2, h: 2, isResizable: false },
      // { i: "n", x: 0, y: 7, w: 1, h: 1, isResizable: false },
      { i: "o", x: 1, y: 5, w: 2, h: 1, isResizable: false },
